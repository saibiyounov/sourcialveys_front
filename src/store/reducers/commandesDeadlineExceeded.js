...
const reducer = (state = initialState, action) => {
    switch(action.type) {
        case actionTypes.COMMANDEDEADLINEEXCEEDED_START: return invoiceStart(state, action)
        case actionTypes.COMMANDEDEADLINEEXCEEDED_SUCCESS: return invoiceSuccess(state, action)
        case actionTypes.COMMANDEDEADLINEEXCEEDED_FAIL: return invoiceFail(state, action)
        case actionTypes.COMMANDEDEADLINEEXCEEDED_SET_PAGE: return invoiceSetPage(state, action)
        case actionTypes.COMMANDEDEADLINEEXCEEDED_SET_PAGESIZE: return invoiceSetPageSize(state, action)
        case actionTypes.COMMANDEDEADLINEEXCEEDED_SET_FILTERSQUERY: return invoiceSetFiltersQuery(state, action)
        case actionTypes.COMMANDEDEADLINEEXCEEDED_SET_SORTQUERY: return invoiceSetSortQuery(state, action)
        case actionTypes.COMMANDEDEADLINEEXCEEDED_SET_REVERSESORT: return invoiceSetReverseSort(state, action)
        case actionTypes.COMMANDEDEADLINEEXCEEDED_UPDATE_SHOWFILTERS: return invoiceUpdateShowFilters(state, action)
        case actionTypes.COMMANDEDEADLINEEXCEEDED_SELECT_ROW: return invoiceSelectRow(state, action)
        case actionTypes.COMMANDEDEADLINEEXCEEDED_SELECT_ALL_ROWS: return invoiceSelectAllRows(state, action)
        case actionTypes.COMMANDEDEADLINEEXCEEDED_SET_QUICKFILTER: return invoiceSetQuickFilter(state, action)
        default:
            return state
    }
}
